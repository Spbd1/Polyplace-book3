...
polyplace/
├── contracts/          # Smart contracts (we'll add full code)
│   ├── NFT.sol
│   └── Marketplace.sol
...
│   └── Marketplace.test.js
├── hardhat.config.js   # Hardhat config for Polygon
├── package.json        # Add deps: hardhat, @openzeppelin/contracts, @infura/ipfs-http-client
├── pages/              # Frontend (existing)
│   ├── index.js        # Marketplace UI
│   └── mint.js         # Mint form
├── components/         # React components (existing)
│   └── NFTContext.js   # Wallet/contract provider
└── utils/              # Helpers (add IPFS utils)
    └── ipfs.js
